...
(() => {
  "use strict";
  const META = {"autarch": ["svg", 640, 420], "autarch-c": ["svg", 640, 420], "autarch-e": ["svg", 640, 420], "bats": ["canvas", 640, 300], "bats-c": ["svg", 640, 360], "blade": ["canvas", 640, 360], "canopic-c": ["svg", 640, 400], "centipede": ["svg", 640, 360], "cylinders": ["svg", 640, 400], "cylinders-b": ["svg", 640, 400], "epitaph": ["svg", 640, 400], "ext1c": ["svg", 640, 400], "fungus": ["svg", 640, 360], "glowstone": ["canvas", 640, 300], "guts-a": ["svg", 640, 360], "guts-b": ["svg", 640, 360], "guts-c": ["svg", 640, 360], "hound": ["svg", 640, 360], "jackal": ["svg", 640, 360], "jar-falcon": ["svg", 640, 300], "jar-jackal": ["svg", 640, 300], "jar-mantis": ["svg", 640, 300], "mystic-b": ["svg", 640, 400], "road": ["svg", 640, 400], "seal": ["svg", 640, 400], "silas": ["svg", 640, 400], "spawn-a": ["svg", 640, 360], "spawn-b": ["svg", 640, 360], "spawn-c": ["svg", 640, 360], "sphere-b": ["svg", 640, 420], "tesseract": ["canvas", 640, 360]};
  const FIG = {
  ...
  FIG._define("road", "svg", function (svg) {
    ...
    const flee = el(svg, "circle", { r: 2.6, fill: PH_BRIGHT, opacity: 0 });
    ...
    clock(t => {
      ...
      if (fallen && T < 170) {                      // the teamster, fleeing south
        ...
        flee.setAttribute("cx", 420 + (T - 130) * 3);
        flee.setAttribute("cy", 280 + (T - 130) * 2.4);
      } else flee.setAttribute("opacity", 0);
      R.forEach((r, i) => {
