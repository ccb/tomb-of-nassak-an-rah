...
Captions = {
	road = {
		...
		-- typed -- then moonset rewrites every line
		{ from = 4, to = 116, x = 14, y = 30, x2 = 148, type = true, cps = 3,
			text = "MERCHANT", text2 = "WITH THE WAGON" },
		{ from = 10, to = 116, x = 14, y = 48, x2 = 148, type = true, cps = 3,
			text = "ZOXEN x2", text2 = "PULLING" },
		{ from = 16, to = 116, x = 14, y = 66, x2 = 148, type = true, cps = 3,
			text = "TEAMSTER", text2 = "DRIVING" },
		{ from = 22, to = 116, x = 14, y = 84, x2 = 148, type = true, cps = 3,
			text = "YOU", text2 = "NOT YET HERE" },
		{ from = 116, x = 14, y = 30, x2 = 148,
			text = "MERCHANT", text2 = "LOST (MOONSET)" },
		{ from = 116, x = 14, y = 48, x2 = 148,
			text = "ZOXEN x2", text2 = "LOST" },
		{ from = 116, x = 14, y = 66, x2 = 148,
			text = "TEAMSTER", text2 = "FLED SOUTH" },
		{ from = 116, x = 14, y = 84, x2 = 148,
			text = "YOU", text2 = "INCOMING", bold = true },
