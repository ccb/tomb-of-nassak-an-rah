...
Captions = {
	road = {
		{ from = 0, x = 8, y = 2, text = "ROAD TO GNOMON", bold = true,
			type = true, cps = 2 },
		-- the party ledger: one line at a time, unhurried -- the whole
		-- trek (the wagon falls at ~116) is the typing's runway
		{ from = 6, x = 14, y = 30, x2 = 148, type = true, cps = 1.5,
			text = "MERCHANT", text2 = "WITH THE WAGON",
			rewrite = { at = 116, retypeAt = 158, text2 = "LOST", cps = 1.5 } },
		{ from = 29, x = 14, y = 48, x2 = 148, type = true, cps = 1.5,
			text = "ZOXEN x2", text2 = "PULLING",
			rewrite = { at = 128, retypeAt = 165, text2 = "LOST", cps = 1.5 } },
		{ from = 47, x = 14, y = 66, x2 = 148, type = true, cps = 1.5,
			text = "TEAMSTER", text2 = "DRIVING",
			rewrite = { at = 135, retypeAt = 172, text2 = "FLED SOUTH",
				cps = 1.5 } },
		{ from = 65, x = 14, y = 84, x2 = 148, type = true, cps = 1.5,
			text = "YOU", text2 = "NOT YET HERE",
			rewrite = { at = 142, retypeAt = 186, text2 = "INCOMING",
				cps = 1.5, bold = true } },
		-- the epitaph waits a beat after the last fate lands
		{ from = 198, x = 200, y = 196, align = "center", type = true,
			cps = 1.5, text = "THE ROAD TO GNOMON IS WALKED" },
		{ from = 220, x = 200, y = 216, align = "center", type = true,
			cps = 1.5, text = "ONLY BY THE DESPERATE. PROVEN AGAIN." },
	},
	["guts-a"] = {
