...
[`build_world.py`](../../backend/build_world.py) /
[`world_map.py`](../../backend/world_map.py)).
...
Read by [`world_map.py`](../../backend/world_map.py). Lives under
...
- **Committed** here: [`backend/world_data.yaml`](../../backend/world_data.yaml)
...
- **Git-ignored / fetched** (from the upstream `base_the_ville_n25`): per-persona
  ...
  are folded in by [`backend/seed.py`](../../backend/seed.py) and tolerate
  being absent.
...
- Backend world model: [`backend/world_map.py`](../../backend/world_map.py),
  [`backend/build_world.py`](../../backend/build_world.py),
  [`backend/seed.py`](../../backend/seed.py),
  [`backend/world_data.yaml`](../../backend/world_data.yaml)
